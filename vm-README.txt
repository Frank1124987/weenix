...
Is the following statement correct about your submission (please replace
    ...
    We run /sbin/init from the kernel init process in our submission": no, using kshell
...
(B.2) /usr/bin/args ab cde fghi j (1 out of 2 pts)
...
(C.1) help (0 out of 1 pt)
(C.2) echo hello (0 out of 1 pt)
(C.3) cat /README (0 out of 1 pt)
(C.4) /bin/ls (0 out of 1 pt)
(C.5) segfault (0 out of 1 pt)

(D.1) /usr/bin/vfstest (0 out of 6 pts)
(D.2) /usr/bin/memtest (0 out of 6 pts)
(D.3) /usr/bin/eatmem (0 out of 6 pts)
(D.4) /usr/bin/forkbomb (0 out of 6 pts)
(D.5) /usr/bin/stress (0 out of 6 pts)
...
1)  Names and USC e-mail addresses of team members: Weifan Chen, weifanc@usc.edu
...
Please skip the following tests: all test in section C, D, E
